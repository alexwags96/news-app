...
@Component({
  selector: 'app-geopolitique',
  templateUrl: './geopolitique.component.html',
  styleUrls: ['./geopolitique.component.scss'],
})
export class GeopolitiqueComponent implements OnInit {
  articles: any;
  maxArticle = '30';
  selectedRam: any;
  filter = 'geopolitique';
